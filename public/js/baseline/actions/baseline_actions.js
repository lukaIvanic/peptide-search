...
export const getBaselineCases = (dataset, batchId = null) => api.getBaselineCases(dataset, batchId);
export const getBaselineLatestRun = (caseId, batchId = null) => api.getBaselineLatestRun(caseId, batchId);
